...
router.put(
    "/profile",
    auth.authenticate,
    learnerController.updateLearnerProfile
);
...
router.delete(
  "/enrollments",
  auth.authenticate,
  learnerController.unenrollCourse
);
...
router.get('/all-course-learners/:courseId', learnerController.getEnrollmentByCourse)

router.delete(
  "/cart/:learnerId/:courseId",
  learnerController.removeCartContent
);
